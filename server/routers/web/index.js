module.exports = app => {
    ...
    router.get('/news/init', async (req, res) => {
        ...
        const newsTitles = ["夏日新版本“稷下星之队”即将6月上线", "王者荣耀携手两大博物馆 走进稷下学宫", "王者大陆第一学院【稷下】档案", "新英雄爆料 | 鲁班七号发明者-鲁班大师曝光，孙膑形象大升级！", "新英雄爆料丨队长“曜”觉醒计划，体验服一手资讯抢先看！", "6月14日安卓建议更新公告", "6月11日全服不停机更新公告", "关于2019年KPL春季赛总决赛 RNG.M vs eStarPro 补赛、赛果及世界冠军杯安排公告", "6月13日体验服停机更新公告", "【已修复】王者大陆的端午宝藏活动页面异常问题说明", "【稷下的邀约】活动公告", "活力夏日活动周 王者峡谷好礼多", "王者大陆的端午宝藏活动公告", "峡谷庆端午 惊喜礼不断", "【场里场外，一起开黑】感恩礼包放送", "【6月15日 再战西安 · 2019年KPL春季赛总决赛重启公告】", "王者荣耀世界冠军杯荣耀来袭，KPL赛区选拔赛谁能突围而出？", "【关于2019年KPL春季赛总决赛门票退换及异地用户现场观赛补贴公告】", "今日17:30，2019KPL春季赛总决赛再战西安！", "KRKPL快讯：Nova快攻节奏暴躁起飞，CW运营维艰惨遭零封"]
    ...
    router.get('/heroes/init', async (req, res) => {
        ...
        for (let cat of rawData) {
            ...
            // 找到当前分类在数据库中对应的数据
            const categry = await Category.findOne({
                name: cat.name
            })
            cat.heroes = cat.heroes.map(hero => {
                hero.categories = [categry]
                return hero
            })
            // 录入英雄
